...
func main() {
	...
	var s_expressions = map[string][]string{
		// "(11:certificate(6:issuer3:bob)(7:subject))": []string{"(11:certificate(6:issuer3:bob)(7:subject5:alice))"},
		// "(11:certificate(6:issuer3:bob)(5:level(1:*5:range7:numeric2:le3:100)))": []string{"(11:certificate(" +
		...
		//
		// "(11:certificate(6:issuer3:bob)(5:fruit(1:*3:set5:apple6:orange5:lemon)))": []string{
		...
		//
		// "(11:certificate(6:issuer3:bob)(4:when(1:*5:range4:date2:ge25:2023-12-22T17:25:33+01:00)))": []string{
		...
		// },
		//
		"(11:certificate(6:issuer3:bob)(4:when(1:*5:range4:time2:ge8:10:30:00)))": []string{
			"(11:certificate(6:issuer3:bob)(4:when8:12:00:00)))",
			"(11:certificate(6:issuer3:bob)(4:when8:09:00:00)))",
		},
	}
	for stringRule, QueryList := range s_expressions {
		var Rule, Query *Node
		var err error
		var cmp bool
